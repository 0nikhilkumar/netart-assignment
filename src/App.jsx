...
function App() {
  return (
    <>
      <div className="logo">
        <img
          src="https://res.cloudinary.com/nikhilkumar/image/upload/v1708977798/images/jnvy3lr67msyk0qhq3e3.png"
          alt="logo"
        />
      </div>
      <div className="main-content">
        <div className="content-div content-div1">
          <img
            src="https://res.cloudinary.com/nikhilkumar/image/upload/v1708977802/images/ohbpidtkbyaivly2zdjn.png"
            alt="award"
          />
        </div>
        <div className="content-div content-div2">
          ...
          <img
            src="https://res.cloudinary.com/nikhilkumar/image/upload/v1708977802/images/vnomvimfwxsksqvuezcr.png"
            alt=""
          />
          <div>
      ...
      <div className="pump-img-div">
        <img
          src="https://res.cloudinary.com/nikhilkumar/image/upload/v1708977801/images/iqfafsrebsfbmwkxlch0.png"
          alt=""
        />
        <p>
      ...
      <div className="contact-us-div">
        <ul className="contact">
          <li>
            <i className="fa fa-phone"></i> Toll free 1800 200 1234
          </li>
          <li>
            <i className="fa fa-facebook-f"></i> www.facebook.com/cripumps
          </li>
          <li>
            <i className="fa fa-globe"></i> www.crigroups.com
          </li>
        </ul>
      </div>
    </>
